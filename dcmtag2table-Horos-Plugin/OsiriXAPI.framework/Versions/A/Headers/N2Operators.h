...
NSRect NSCleanRect(NSRect r);
NSPoint NSMiddlePoint( NSPoint p1, NSPoint p2);

NSPoint NSUpRect(NSRect r);
NSPoint NSDownRect(NSRect r);
NSPoint NSLeftRect(NSRect r);
NSPoint NSRightRect(NSRect r);
