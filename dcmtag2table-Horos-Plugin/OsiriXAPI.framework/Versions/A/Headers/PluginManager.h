...
+ (NSDictionary*) pluginsInfoDictionary;
...
+ (BOOL) validSignatureForPath: (NSString*) path;
+ (NSDictionary*) teamIDForBundle: (NSBundle*) plugin;
...
+ (BOOL)movePluginFromPath:(NSString*)sourcePath toPath:(NSString*)destinationPath;
