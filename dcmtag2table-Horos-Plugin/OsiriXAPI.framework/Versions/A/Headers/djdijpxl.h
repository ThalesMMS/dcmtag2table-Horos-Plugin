 ...
 */
class DJDecompressJPXL : public DJDecoder
{
public:
   ...
   */
    DJDecompressJPXL(const DJCodecParameter& cp, OFBool isYBR);

  /// destructor
  virtual ~DJDecompressJPXL();
...
private:
  ...
  /// private undefined copy constructor
    DJDecompressJPXL(const DJDecompressJPXL&);

  /// private undefined copy assignment operator
    DJDecompressJPXL& operator=(const DJDecompressJPXL&);
