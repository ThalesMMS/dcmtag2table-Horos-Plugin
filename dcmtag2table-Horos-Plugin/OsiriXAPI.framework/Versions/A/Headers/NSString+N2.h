...
typedef NS_ENUM(NSInteger, TextAlignment) {
    ...
    TextAlignmentCenterLeft,
    TextAlignmentCenterRight,
...
-(NSString*)stringByRemovingInsertionPoints;
-(NSString*)stringByRemovingCombiningMarks;
-(NSString*)sanitizeFileName;
-(NSString*)withoutWhitespaceSequences;
-(unsigned int)countCharacters;
- (void)drawStringInRect:(CGRect)rect withAttributes:(NSDictionary *)attributes alignment:(TextAlignment)alignment;
