...
@interface PluginManagerController : NSWindowController <NSURLDownloadDelegate, WKNavigationDelegate, WKUIDelegate>
{
...
@property (retain) NSString *errorPopoverMessage, *loadURL;
