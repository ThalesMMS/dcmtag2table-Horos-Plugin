...
@private
    ...
    NSMutableArray *runLoops, *httpThreads, *webPortalDatabases;
...
@property(readonly) NSMutableArray *runLoops, *httpThreads, *webPortalDatabases;
...
- (void) resetLoopsLoad;
- (WebPortalDatabase*) webPortaldatabaseForCurrentThread;
