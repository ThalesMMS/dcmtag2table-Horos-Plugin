...
@interface ViewerController : OSIWindowController  <NSWindowDelegate, NSSplitViewDelegate, NSToolbarDelegate, NSMenuDelegate>
{
    ...
    NSMutableArray *viewerHistoryBack, *viewerHistoryForward;
    ...
    IBOutlet NSMenu         *WorkspacesToolbarItemMenu, *windowsTilingNSMenu;
    ...
    BOOL                    setPixelsIfLarger, setPixelsIfSmaller, setPixelsPropagateTo4D, setPixelsInOrOut;
    float                   setPixelsMinValue, setPixelsMaxValue, setPixelsToValue;
    int                     setPixelsApplyTo, setPixelsToValueMode;
    ...
    NSArray                 *morphoSelectedROIs, *morphoOriginalROIs;
...
//	BOOL					windowIsMovedByTheUser;
    ...
    BOOL newViewerControllerAllocated, dontCaptureUndoEvents, allPixLoaded;
    BOOL syncAutoMode;
}
@property BOOL preFlipped, sortedInAscending, allPixLoaded;
...
@property(retain) NSString *sortedByKey, *reportURL, *seriesIDAtInit;
...
@property(readonly) NSMenu *windowsTilingNSMenu;
@property(retain) NSArray *morphoOriginalROIs, *morphoSelectedROIs;
@property(retain) NSString *morphoFunction;
...
@property BOOL setPixelsIfLarger, setPixelsIfSmaller, setPixelsPropagateTo4D, setPixelsInOrOut;
@property float setPixelsMinValue, setPixelsMaxValue, setPixelsToValue;
@property int setPixelsApplyTo, setPixelsToValueMode;

@property NSUInteger chronologicalStudyIndex;
...
+(ViewerController*) viewerControllerWithSeries:(DicomSeries*) series;
+(ViewerController*) viewerControllerWithImages:(NSArray <DicomImage*>*) images;
...
+ (ViewerController*) newWindowWithWidth: (int) pixWidth height: (int) pixHeight slices: (int) sliceCount;
...
+ (double) computeOriginalOrientationForPixArray: (NSArray*) pixList orientationVector:(OrientationVector*)orientationVector;
...
+ (ROIManagerController*) roiManager;
...
- (IBAction) setWindowsTilingWithTag:(int) tag;
...
- (void)prepareHistoryMenu: (NSMenu*) menu;
...
- (NSArray*) mergeBrushROIsOnEachImage: (NSArray*) s;
- (IBAction) mergeBrushROIsWithSameName: (id) sender;
...
- (void) changeImageDataWithPix:(NSMutableArray*)f images:(NSMutableArray*)d data:(NSData*) v newViewer:(BOOL) newViewerWindow loadROI: (BOOL) loadROI;
...
- (void) deleteROIs: (NSArray*) rois;
- (void) deleteSeriesROIwithName: (NSString*) name;
- (void) deleteSeriesROIwithNames: (NSArray<NSString*>* ) names;
...
- (void) roiVolume:(int) tag ROI: (ROI*) selectedRoi;
...
+ (void) applyOnlySamePatient: (DicomStudy*) study;
...
- (void) morphoTransform: (NSString*) function ROIs: (NSArray*) ROIs;
