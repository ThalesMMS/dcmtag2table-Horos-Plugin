...
+ (NSDictionary*) getImageRefSOPInstanceUID:(NSString*) path;
...
- (id) initWithDictionary:(NSDictionary *) dict path:(NSString *) path forImage: (DicomImage*) im seriesNumber: (int) number seriesDescription: (NSString*) description;
