...
@interface DicomStudy : NSManagedObject
{
    ...
    NSSet *cacheKeyImages, *cacheKeyOnlyOneImageIfEntireSeriesImages;
    BOOL reentry;
    BOOL setDICOMSRAsImportedByOsiriX;
...
@property BOOL setDICOMSRAsImportedByOsiriX;
...
- (NSSet*) keyImages;
- (NSSet*) keyImagesOnlyOneImageIfEntireSeries:(BOOL) OnlyOneImageIfEntireSeries;
- (BOOL) isVolumic;
...
- (NSArray*)imageSeriesContainingPixels:(BOOL) pixels includeLocalizersSeries: (BOOL) includeLocalizersSeries sorted:(BOOL) sorted includeHidden:(BOOL) includeHidden;
...
- (void) archiveNoteAsDICOMSR:(NSData*) d;
- (NSData*) noteData;
- (NSAttributedString*) noteString;
- (NSString*) noteHTML;
- (NSData*) noteWebArchive;
...
+ (NSArray*) distantStudiesForStudy: (DicomStudy*) studySelected;
+ (NSArray*) comparativeStudiesForStudy: (id) studySelectedID;
+ (NSArray*) comparativeStudiesForStudy: (DicomStudy*) studySelected useCacheForLocal: (BOOL) useCacheForLocal includeDistant: (BOOL) includeDistant;
