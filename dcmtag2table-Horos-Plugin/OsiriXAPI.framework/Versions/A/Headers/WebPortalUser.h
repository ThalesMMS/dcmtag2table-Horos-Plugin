...
@property (nonatomic, retain) NSNumber * downloadNote;
...
+(BOOL)validatePassword:(NSString**)value name: (NSString*) name error:(NSError**)error;
...
-(NSArray*)studiesForPredicate:(NSPredicate*)predicate dicomDatabase: (DicomDatabase*) dicomDatabase;
...
+(NSArray*)studiesForUser: (WebPortalUser*) user predicate:(id)predicate dicomDatabase: (DicomDatabase*) dicomDatabase;
