...
+ (NSDictionary*) readDICOMSRForFile: (NSString*) file;
...
+ (NSData*) getPixelDataForFrame: (int) frame forFile: (NSString*) path;

#ifdef __cplusplus
+ (NSString*) getDicomFieldFoTagKey: (DcmTagKey) key forDcmFileFormat: (void*) ff;
#endif
