...
@interface DicomDatabase : N2ManagedDatabase {
    ...
    BOOL notRecommendedVolumeFormat, archiveAnnotationsAsDICOMSR;
    ...
    BOOL protectionAgainstReentry, saving, rebuildMode;
...
-(DicomDatabase*)databaseForCurrentThread;
+(DicomDatabase*)databaseForCurrentThread:(DicomDatabase*)database;
...
@property BOOL hasPotentiallySlowDataAccess, rebuildMode;
...
-(NSArray*)albums;
-(NSArray*)smartAlbums;
-(NSArray*)staticAlbums;
-(DicomAlbum*) albumWithName: (NSString*) name;
...
-(BOOL)applyIncomingSyntaxConversionToPaths:(NSArray*) paths;
